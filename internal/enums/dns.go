...
const (
	...
	PACKET_STREAM_RESEND           = 0x11 // 17
	PACKET_PACKED_CONTROL_BLOCKS   = 0x12 // 18
	PACKET_STREAM_FIN              = 0x13 // 19
	PACKET_STREAM_FIN_ACK          = 0x14 // 20
	PACKET_STREAM_RST              = 0x15 // 21
	PACKET_STREAM_RST_ACK          = 0x16 // 22

	// SOCKS5 stream setup packets
	PACKET_SOCKS5_SYN     = 0x17 // 23
	PACKET_SOCKS5_SYN_ACK = 0x18 // 24

	// SOCKS5 result packets
	PACKET_SOCKS5_CONNECT_FAIL                 = 0x19 // 25
	PACKET_SOCKS5_CONNECT_FAIL_ACK             = 0x1A // 26
	PACKET_SOCKS5_RULESET_DENIED               = 0x1B // 27
	PACKET_SOCKS5_RULESET_DENIED_ACK           = 0x1C // 28
	PACKET_SOCKS5_NETWORK_UNREACHABLE          = 0x1D // 29
	PACKET_SOCKS5_NETWORK_UNREACHABLE_ACK      = 0x1E // 30
	PACKET_SOCKS5_HOST_UNREACHABLE             = 0x1F // 31
	PACKET_SOCKS5_HOST_UNREACHABLE_ACK         = 0x20 // 32
	PACKET_SOCKS5_CONNECTION_REFUSED           = 0x21 // 33
	PACKET_SOCKS5_CONNECTION_REFUSED_ACK       = 0x22 // 34
	PACKET_SOCKS5_TTL_EXPIRED                  = 0x23 // 35
	PACKET_SOCKS5_TTL_EXPIRED_ACK              = 0x24 // 36
	PACKET_SOCKS5_COMMAND_UNSUPPORTED          = 0x25 // 37
	PACKET_SOCKS5_COMMAND_UNSUPPORTED_ACK      = 0x26 // 38
	PACKET_SOCKS5_ADDRESS_TYPE_UNSUPPORTED     = 0x27 // 39
	PACKET_SOCKS5_ADDRESS_TYPE_UNSUPPORTED_ACK = 0x28 // 40
	PACKET_SOCKS5_AUTH_FAILED                  = 0x29 // 41
	PACKET_SOCKS5_AUTH_FAILED_ACK              = 0x2A // 42
	PACKET_SOCKS5_UPSTREAM_UNAVAILABLE         = 0x2B // 43
	PACKET_SOCKS5_UPSTREAM_UNAVAILABLE_ACK     = 0x2C // 44
	PACKET_SOCKS5_CONNECTED                    = 0x2D // 45
	PACKET_SOCKS5_CONNECTED_ACK                = 0x2E // 46

	// DNS tunnel packets
	PACKET_DNS_QUERY_REQ     = 0x2F // 47
	PACKET_DNS_QUERY_RES     = 0x30 // 48
	PACKET_DNS_QUERY_REQ_ACK = 0x31 // 49
	PACKET_DNS_QUERY_RES_ACK = 0x32 // 50
