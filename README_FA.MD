...
### گام ۱.۲: 🐧 نصب و راه‌اندازی سریع سرور لینوکس 
...
> ⚠️ **نکتهٔ مهم ۱:** قبل از اجرای این اسکریپت، باید مالک دامنه باشید و تنظیمات DNS بخش ۱.۱ را کامل کرده باشید.
>
> ⚠️ **نکتهٔ مهم ۲:** این اسکریپت فقط سرور لینوکس را نصب می‌کند. برای اجرای کلاینت روی سیستم خودتان، از گام ۲ استفاده کنید.
>
...
>
> ⚠️ **نکتهٔ مهم ۴:** ترجیحا از آخرین نسخه سیستم عاملی که پشتیبانی می‌شود استفاده کنید  تا بهترین عملکرد و سازگاری را داشته باشید.
>
> ⚠️ **نکتهٔ مهم ۵:** پس از اجرای اسکریپت و نصب سرور حتما کلید رمزنگاری را یادداشت کنید و در جای امن نگه دارید، چون برای اتصال کلاینت به سرور ضروری است.
